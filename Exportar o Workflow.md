...
1. Clique no botão **três pontos (⋯)** ou **menu do workflow**
...
Esse será o arquivo utilizado pelos avaliadores para **importar e testar o seu workflow**.
...
- confirme se o fluxo retorna uma resposta correta

Isso garante que os avaliadores consigam executar o projeto corretamente.
